...
import { useGetSupplierOrderStatistics } from "@/services/api/supplier_order/hooks";
...
const SupplierOrderStatistics = () => {
    const { data: statistics, isPending } = useGetSupplierOrderStatistics();
