...
import { useGetClientOrderStatistics } from "@/services/api/ClientOrder/hooks";
...
const ClientOrderStatistics = () => {
    const { data: statistics, isPending } = useGetClientOrderStatistics();
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex justify-between items-center pt-2 border-t border-gray-200">
                                ...
                                <span className="text-lg font-bold text-red-600">
                                    {statistics.data?.totalAmountIncludingTaxToPay} {Currency}
                                </span>
                            </div>
                        </div>
                    }
...
export default ClientOrderStatistics;
